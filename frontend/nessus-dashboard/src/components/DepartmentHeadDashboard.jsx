...
import { Card, Typography, Space, Table, Tag, Button, Modal, message, Input, Select, Row, Col, Timeline } from 'antd';
import { CheckCircleOutlined, CloseCircleOutlined, ClockCircleOutlined, SearchOutlined, InfoCircleOutlined } from '@ant-design/icons';
    ...
    try {
      ...
      await axios.put(
        ...
        { 
          ...
          approvalPhase: 'DEPARTMENT_HEAD_REVIEW'
        },
        { withCredentials: true }
      );
            ...
            <Space direction="vertical" style={{ width: '100%' }}>
              <Row gutter={[16, 16]}>
                <Col span={12}>
                  ...
                  <Paragraph>
                    <Text strong>Request ID:</Text> {selectedRequest.requestID}<br />
